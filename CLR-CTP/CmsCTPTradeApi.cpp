...
namespace CTPCLR
{
	public ref class CmsTradeApiclr :ICTPTradeApi
{
private:
...
public:
	...
	CmsTradeApiclr(System::String ^_investor, System::String ^_pwd, System::String ^_broker,
		System::String ^_addr , System::String ^_FlowPath)
	{
		...
		pUserApi = CCmsTraderApi::CreateFtdcTraderApi(MarshalString(_FlowPath).c_str());			// 创建UserApi
		pUserSpi = new CmsTraderSpi();
		pUserApi->RegisterSpi((CCmsTraderSpi*)pUserSpi);			// 注册事件类
...
private:
	void EventInit()
	{
		...
		{
			cppFrontConnect^ fp = gcnew cppFrontConnect(this, &CmsTradeApiclr::cppcbFrontConnect);
		...
		{
			cppDisConnected^ fp = gcnew cppDisConnected(this, &CmsTradeApiclr::cppcbDisConnected);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppHeartBeatWarning^ fp = gcnew cppHeartBeatWarning(this, &CmsTradeApiclr::cppcbHeartBeatWarning);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppErrRtnBankToFutureByFuture^ fp = gcnew cppErrRtnBankToFutureByFuture(this, &CmsTradeApiclr::cppcbErrRtnBankToFutureByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppErrRtnFutureToBankByFuture^ fp = gcnew cppErrRtnFutureToBankByFuture(this, &CmsTradeApiclr::cppcbErrRtnFutureToBankByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppErrRtnOrderAction^ fp = gcnew cppErrRtnOrderAction(this, &CmsTradeApiclr::cppcbErrRtnOrderAction);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppErrRtnOrderInsert^ fp = gcnew cppErrRtnOrderInsert(this, &CmsTradeApiclr::cppcbErrRtnOrderInsert);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppErrRtnQueryBankBalanceByFuture^ fp = gcnew cppErrRtnQueryBankBalanceByFuture(this, &CmsTradeApiclr::cppcbErrRtnQueryBankBalanceByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppErrRtnRepealBankToFutureByFutureManual^ fp = gcnew cppErrRtnRepealBankToFutureByFutureManual(this, &CmsTradeApiclr::cppcbErrRtnRepealBankToFutureByFutureManual);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppErrRtnRepealFutureToBankByFutureManual^ fp = gcnew cppErrRtnRepealFutureToBankByFutureManual(this, &CmsTradeApiclr::cppcbErrRtnRepealFutureToBankByFutureManual);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspError^ fp = gcnew cppRspError(this, &CmsTradeApiclr::cppcbRspError);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspFromBankToFutureByFuture^ fp = gcnew cppRspFromBankToFutureByFuture(this, &CmsTradeApiclr::cppcbRspFromBankToFutureByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspFromFutureToBankByFuture^ fp = gcnew cppRspFromFutureToBankByFuture(this, &CmsTradeApiclr::cppcbRspFromFutureToBankByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspOrderAction^ fp = gcnew cppRspOrderAction(this, &CmsTradeApiclr::cppcbRspOrderAction);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspOrderInsert^ fp = gcnew cppRspOrderInsert(this, &CmsTradeApiclr::cppcbRspOrderInsert);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspParkedOrderAction^ fp = gcnew cppRspParkedOrderAction(this, &CmsTradeApiclr::cppcbRspParkedOrderAction);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspParkedOrderInsert^ fp = gcnew cppRspParkedOrderInsert(this, &CmsTradeApiclr::cppcbRspParkedOrderInsert);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryBrokerTradingAlgos^ fp = gcnew cppRspQryBrokerTradingAlgos(this, &CmsTradeApiclr::cppcbRspQryBrokerTradingAlgos);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryBrokerTradingParams^ fp = gcnew cppRspQryBrokerTradingParams(this, &CmsTradeApiclr::cppcbRspQryBrokerTradingParams);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryCFMMCTradingAccountKey^ fp = gcnew cppRspQryCFMMCTradingAccountKey(this, &CmsTradeApiclr::cppcbRspQryCFMMCTradingAccountKey);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryContractBank^ fp = gcnew cppRspQryContractBank(this, &CmsTradeApiclr::cppcbRspQryContractBank);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryDepthMarketData^ fp = gcnew cppRspQryDepthMarketData(this, &CmsTradeApiclr::cppcbRspQryDepthMarketData);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryExchange^ fp = gcnew cppRspQryExchange(this, &CmsTradeApiclr::cppcbRspQryExchange);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryInstrument^ fp = gcnew cppRspQryInstrument(this, &CmsTradeApiclr::cppcbRspQryInstrument);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryInstrumentCommissionRate^ fp = gcnew cppRspQryInstrumentCommissionRate(this, &CmsTradeApiclr::cppcbRspQryInstrumentCommissionRate);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryInstrumentMarginRate^ fp = gcnew cppRspQryInstrumentMarginRate(this, &CmsTradeApiclr::cppcbRspQryInstrumentMarginRate);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryInvestor^ fp = gcnew cppRspQryInvestor(this, &CmsTradeApiclr::cppcbRspQryInvestor);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryInvestorPosition^ fp = gcnew cppRspQryInvestorPosition(this, &CmsTradeApiclr::cppcbRspQryInvestorPosition);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryInvestorPositionCombineDetail^ fp = gcnew cppRspQryInvestorPositionCombineDetail(this, &CmsTradeApiclr::cppcbRspQryInvestorPositionCombineDetail);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryInvestorPositionDetail^ fp = gcnew cppRspQryInvestorPositionDetail(this, &CmsTradeApiclr::cppcbRspQryInvestorPositionDetail);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryNotice^ fp = gcnew cppRspQryNotice(this, &CmsTradeApiclr::cppcbRspQryNotice);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryOrder^ fp = gcnew cppRspQryOrder(this, &CmsTradeApiclr::cppcbRspQryOrder);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryParkedOrder^ fp = gcnew cppRspQryParkedOrder(this, &CmsTradeApiclr::cppcbRspQryParkedOrder);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryParkedOrderAction^ fp = gcnew cppRspQryParkedOrderAction(this, &CmsTradeApiclr::cppcbRspQryParkedOrderAction);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQrySettlementInfo^ fp = gcnew cppRspQrySettlementInfo(this, &CmsTradeApiclr::cppcbRspQrySettlementInfo);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQrySettlementInfoConfirm^ fp = gcnew cppRspQrySettlementInfoConfirm(this, &CmsTradeApiclr::cppcbRspQrySettlementInfoConfirm);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryTrade^ fp = gcnew cppRspQryTrade(this, &CmsTradeApiclr::cppcbRspQryTrade);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryTradingAccount^ fp = gcnew cppRspQryTradingAccount(this, &CmsTradeApiclr::cppcbRspQryTradingAccount);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryTradingCode^ fp = gcnew cppRspQryTradingCode(this, &CmsTradeApiclr::cppcbRspQryTradingCode);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryTradingNotice^ fp = gcnew cppRspQryTradingNotice(this, &CmsTradeApiclr::cppcbRspQryTradingNotice);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryTransferBank^ fp = gcnew cppRspQryTransferBank(this, &CmsTradeApiclr::cppcbRspQryTransferBank);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryTransferSerial^ fp = gcnew cppRspQryTransferSerial(this, &CmsTradeApiclr::cppcbRspQryTransferSerial);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQryAccountregister^ fp = gcnew cppRspQryAccountregister(this, &CmsTradeApiclr::cppcbRspQryAccountregister);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQueryBankAccountMoneyByFuture^ fp = gcnew cppRspQueryBankAccountMoneyByFuture(this, &CmsTradeApiclr::cppcbRspQueryBankAccountMoneyByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspQueryMaxOrderVolume^ fp = gcnew cppRspQueryMaxOrderVolume(this, &CmsTradeApiclr::cppcbRspQueryMaxOrderVolume);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspRemoveParkedOrder^ fp = gcnew cppRspRemoveParkedOrder(this, &CmsTradeApiclr::cppcbRspRemoveParkedOrder);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspRemoveParkedOrderAction^ fp = gcnew cppRspRemoveParkedOrderAction(this, &CmsTradeApiclr::cppcbRspRemoveParkedOrderAction);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspSettlementInfoConfirm^ fp = gcnew cppRspSettlementInfoConfirm(this, &CmsTradeApiclr::cppcbRspSettlementInfoConfirm);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspTradingAccountPasswordUpdate^ fp = gcnew cppRspTradingAccountPasswordUpdate(this, &CmsTradeApiclr::cppcbRspTradingAccountPasswordUpdate);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
				cppRspAuthenticate^ fp = gcnew cppRspAuthenticate(this, &CmsTradeApiclr::cppcbRspAuthenticate);
				GCHandle gch = GCHandle::Alloc(fp);
				gchlist->Add(gch);
				IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspUserLogin^ fp = gcnew cppRspUserLogin(this, &CmsTradeApiclr::cppcbRspUserLogin);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspUserLogout^ fp = gcnew cppRspUserLogout(this, &CmsTradeApiclr::cppcbRspUserLogout);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRspUserPasswordUpdate^ fp = gcnew cppRspUserPasswordUpdate(this, &CmsTradeApiclr::cppcbRspUserPasswordUpdate);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnErrorConditionalOrder^ fp = gcnew cppRtnErrorConditionalOrder(this, &CmsTradeApiclr::cppcbRtnErrorConditionalOrder);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnFromBankToFutureByBank^ fp = gcnew cppRtnFromBankToFutureByBank(this, &CmsTradeApiclr::cppcbRtnFromBankToFutureByBank);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnFromBankToFutureByFuture^ fp = gcnew cppRtnFromBankToFutureByFuture(this, &CmsTradeApiclr::cppcbRtnFromBankToFutureByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnFromFutureToBankByBank^ fp = gcnew cppRtnFromFutureToBankByBank(this, &CmsTradeApiclr::cppcbRtnFromFutureToBankByBank);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnFromFutureToBankByFuture^ fp = gcnew cppRtnFromFutureToBankByFuture(this, &CmsTradeApiclr::cppcbRtnFromFutureToBankByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnInstrumentStatus^ fp = gcnew cppRtnInstrumentStatus(this, &CmsTradeApiclr::cppcbRtnInstrumentStatus);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnOrder^ fp = gcnew cppRtnOrder(this, &CmsTradeApiclr::cppcbRtnOrder);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnQueryBankBalanceByFuture^ fp = gcnew cppRtnQueryBankBalanceByFuture(this, &CmsTradeApiclr::cppcbRtnQueryBankBalanceByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnRepealFromBankToFutureByBank^ fp = gcnew cppRtnRepealFromBankToFutureByBank(this, &CmsTradeApiclr::cppcbRtnRepealFromBankToFutureByBank);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnRepealFromBankToFutureByFuture^ fp = gcnew cppRtnRepealFromBankToFutureByFuture(this, &CmsTradeApiclr::cppcbRtnRepealFromBankToFutureByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnRepealFromBankToFutureByFutureManual^ fp = gcnew cppRtnRepealFromBankToFutureByFutureManual(this, &CmsTradeApiclr::cppcbRtnRepealFromBankToFutureByFutureManual);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnRepealFromFutureToBankByBank^ fp = gcnew cppRtnRepealFromFutureToBankByBank(this, &CmsTradeApiclr::cppcbRtnRepealFromFutureToBankByBank);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnRepealFromFutureToBankByFuture^ fp = gcnew cppRtnRepealFromFutureToBankByFuture(this, &CmsTradeApiclr::cppcbRtnRepealFromFutureToBankByFuture);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnRepealFromFutureToBankByFutureManual^ fp = gcnew cppRtnRepealFromFutureToBankByFutureManual(this, &CmsTradeApiclr::cppcbRtnRepealFromFutureToBankByFutureManual);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnTrade^ fp = gcnew cppRtnTrade(this, &CmsTradeApiclr::cppcbRtnTrade);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
		...
		{
			cppRtnTradingNotice^ fp = gcnew cppRtnTradingNotice(this, &CmsTradeApiclr::cppcbRtnTradingNotice);
			GCHandle gch = GCHandle::Alloc(fp);
			gchlist->Add(gch);
			IntPtr ip = Marshal::GetFunctionPointerForDelegate(fp);
...
private:
	CmsTraderSpi *pUserSpi = nullptr;
	CCmsTraderApi * pUserApi = nullptr;
	int lRequestID = 0;
};
