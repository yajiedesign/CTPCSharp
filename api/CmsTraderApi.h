...
#if !defined(CMS_TRADERAPI_H)
#define CMS_TRADERAPI_H
...
class TRADER_API_EXPORT CCmsTraderApi
{
public:
	///创建TraderApi
	///@param pszFlowPath 存贮订阅信息文件的目录，默认为当前目录
	///@return 创建出的UserApi
	static CCmsTraderApi *CreateFtdcTraderApi(const char *pszFlowPath = "");
	...
	virtual void RegisterSpi(CCmsTraderSpi *pSpi);
...
public:
	CCmsTraderApi( const char *pszFlowPath = "" );
	virtual ~CCmsTraderApi( );
};
